CREATE DATABASE  IF NOT EXISTS `chatbotnhom5` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `chatbotnhom5`;
--
-- ------------------------------------------------------
...
(1, 'GỎI BÒ NGŨ SẮC', 139000),
(2, 'CHẢ GIÒ HẢI SẢN TRÁI CÂY', 69000),
(3, 'NEM HẢI SẢN HÀ THÀNH', 29000),
(4, 'BABA NỔ MUỐI HỘT', 100000),
(5, 'CÁ TẦM NƯỚNG MUỐI ỚT', 100000),
(6, 'LẨU CAY TỨ XUYÊN TRƯỜNG THỌ', 350000),
(7, 'LẨU CỐT CHANH CÁ MŨ', 100000),
(8, 'LẨU THÁI HẢI SẢN', 334000),
(9, 'TÔM CÀNG XANH SỐT TRỨNG', 10000);
...
INSERT INTO `order_tracking` VALUES (40,'đã giao hàng'),(41,'chưa giao hàng');
